...
// Add slider
add_action('wp_ajax_surfaceslider_addSlider', 'surfaceslider_addSlider_callback');
function surfaceslider_addSlider_callback() {
	global $wpdb;
	$options = $_POST['datas'];
...
// Edit slider
add_action('wp_ajax_surfaceslider_editSlider', 'surfaceslider_editSlider_callback');
function surfaceslider_editSlider_callback() {
	global $wpdb;
	$options = $_POST['datas'];
	$table_name = $wpdb->prefix . 'surfaceslider_sliders';
...
add_action('wp_ajax_surfaceslider_editSlides', 'surfaceslider_editSlides_callback');
function surfaceslider_editSlides_callback() {
	global $wpdb;
	$options = $_POST['datas'];
...
add_action('wp_ajax_surfaceslider_editElements', 'surfaceslider_editElements_callback');
function surfaceslider_editElements_callback() {
	global $wpdb;
	$options = $_POST['datas'];
...
add_action('wp_ajax_surfaceslider_deleteSlider', 'surfaceslider_deleteSlider_callback');
function surfaceslider_deleteSlider_callback() {
	global $wpdb;
	$options = $_POST['datas'];
